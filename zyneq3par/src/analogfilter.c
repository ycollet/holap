...
void
AnalogFilter_Init(ZEq3par_t * s, AnalogFilter *filter, unsigned char Ftype, float Ffreq, float Fq, unsigned char Fstages)
{
...
void
AnalogFilter_Cleanup (ZEq3par_t * s, AnalogFilter *filter)
{
  int i;
...
void
computefiltercoefs (ZEq3par_t * s, AnalogFilter *filter)
{
  float tmp;
...
void
setfreq (ZEq3par_t * s, AnalogFilter *filter, float frequency)
{
  int i;
  if (frequency < 0.1)
    frequency = 0.1;
...
void
setfreq_and_q (ZEq3par_t * s, AnalogFilter *filter,float frequency, float q_)
{
  filter->q = q_;
...
void
setq (ZEq3par_t * s, AnalogFilter *filter, float q_)
{
  filter->q = q_;
  computefiltercoefs (s,filter);
};
...
void
settype (ZEq3par_t * s, AnalogFilter *filter, int type_)
{
  filter->type = type_;
  computefiltercoefs (s,filter);
};
...
void
setgain (ZEq3par_t * s, AnalogFilter *filter, float dBgain)
{
...
void
setstages (ZEq3par_t * s, AnalogFilter *filter, int stages_)
{
...
void
singlefilterout (ZEq3par_t * s, AnalogFilter *filter, float * smp, fstage *x, fstage  *y,
...
void
filterout (ZEq3par_t * s, AnalogFilter *filter, float * smp, unsigned long count)
{
  int i;
...
float 
H (ZEq3par_t * s, AnalogFilter *filter, float freq)
{
  int n; 
