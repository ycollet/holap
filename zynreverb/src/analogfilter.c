...
void
AnalogFilter_Init(ZReverb_t * s, AnalogFilter *filter, unsigned char Ftype, float Ffreq, float Fq, unsigned char Fstages)
{
...
void
AnalogFilter_Cleanup (ZReverb_t * s, AnalogFilter *filter)
{
  int i;
...
void
computefiltercoefs (ZReverb_t * s, AnalogFilter *filter)
{
  float tmp;
...
void
setfreq (ZReverb_t * s, AnalogFilter *filter, float frequency)
{
  int i;
  if (frequency < 0.1)
    frequency = 0.1;
...
void
setfreq_and_q (ZReverb_t * s, AnalogFilter *filter,float frequency, float q_)
{
  filter->q = q_;
...
void
setq (ZReverb_t * s, AnalogFilter *filter, float q_)
{
  filter->q = q_;
  computefiltercoefs (s,filter);
};
...
void
settype (ZReverb_t * s, AnalogFilter *filter, int type_)
{
  filter->type = type_;
  computefiltercoefs (s,filter);
};
...
void
setgain (ZReverb_t * s, AnalogFilter *filter, float dBgain)
{
...
void
setstages (ZReverb_t * s, AnalogFilter *filter, int stages_)
{
...
void
singlefilterout (ZReverb_t * s, AnalogFilter *filter, float * smp, fstage *x, fstage  *y,
...
void
filterout (ZReverb_t * s, AnalogFilter *filter, float * smp, unsigned long count)
{
  int i;
...
float 
H (ZReverb_t * s, AnalogFilter *filter, float freq)
{
  int n; 
