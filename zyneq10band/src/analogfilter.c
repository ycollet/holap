...
void
AnalogFilter_Cleanup (ZEq10ban_t * s, AnalogFilter *filter)
{
  int i;
...
void
singlefilterout (ZEq10ban_t * s, AnalogFilter *filter, float * smp, fstage *x, fstage  *y,
...
float 
H (ZEq10ban_t * s, AnalogFilter *filter, float freq)
{
  int n; 
